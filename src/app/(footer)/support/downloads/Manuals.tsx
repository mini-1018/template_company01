...
export default function Manuals() {
  ...
  // 샘플 데이터 - 다운로드 링크 및 상세 정보 추가
  const posts = [
    {
      id: 29,
      category: '친환경',
      title: '재활용품 무인회수기 사용설명서',
      date: '2025-12-11',
      fileSize: '2.5MB',
      description: '재활용품 무인회수기 사용설명서',
      downloadUrl: '/doc/코다_환경제품_카다로그.pdf'
    },
    {
      id: 28,
      category: '헬스케어',
      title: '신장 체중 자동 측정기 (GL-150R) 사용설명서',
      date: '2025-12-11',
      fileSize: '3.2MB',
      description: 'GL-150R 모델 사용설명서',
      downloadUrl: '/doc/코다_환경제품_카다로그.pdf'
    },
    {
      id: 27,
      category: '농축산',
      title: '포도 조합 선별기 사용설명서',
      date: '2025-12-11',
      fileSize: '4.1MB',
      description: '포도 선별기 사용설명서',
      downloadUrl: '/doc/코다_환경제품_카다로그.pdf'
    },
          ...
          currentPosts.map((post, index) => (
            <div key={post.id}>
              <div
                ...
                className={`grid grid-cols-12 border-b border-gray-primary hover:bg-gray-secondary transition-colors cursor-pointer ${index === currentPosts.length - 1 && expandedId !== post.id ? 'border-b-0' : ''
                  }`}
              >
