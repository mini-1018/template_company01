export const historyData = [
    {
      year: "2025",
      items: [
        { month: "01", content: "음식물 종량기(GFS-150CS) 우수 조달품 지정" },
    ...
    },
    {
      year: "2024",
      items: [
        { month: "04", content: "재활용품 무인회수기 직접생산증명 등록" },
        { month: "06", content: "친환경 자원 순환 브랜드 코다(CODA) 런칭" },
    ...
    },
    {
      year: "2023",
      items: [
        { month: "03", content: "고용노동부 2023년 강소기업 선정" },
        { month: "06", content: "중소기업청 INNOBIZ 인증" },
    ...
    },
    {
      year: "2022",
      items: [
        { month: "05", content: "절전형 음식물 종량기 녹색기술 인증 획득" },
    ...
    },
    {
      year: "2018",
      items: [
        { month: "04", content: "중소벤처기업부 글로벌 강소기업 선정" },
        { month: "05", content: "음식물 종량기(GFS-150C) 싱가포르 수출" },
    ...
    },
    {
      year: "2015",
      items: [
        { month: "03", content: "2015 KIMES 의료기기 전시회 참가" },
    ...
    },
    {
      year: "2014",
      items: [
        { month: "03", content: "2014 KIMES 의료기기 전시회 참가" },
    ...
    },
    {
      year: "2013",
      items: [
        { month: "03", content: "2013 KIMES 의료기기 전시회 참가" },
    ...
    },
    {
      year: "2012",
      items: [
        { month: "03", content: "2012 KIMES 의료기기 전시회 참가" },
        { month: "07", content: "코웨이 안마의자(DR-6120) 출시" },
    ...
    },
    {
      year: "2011",
      items: [
        { month: "06", content: "중소기업청 경기중소기업인상 수상" },
        { month: "08", content: "중국 북경 해외법인 설립" },
    ...
    },
    {
      ...
      items: [
        { month: "04", content: "과학기술부 장관 표창" },
        { month: "06", content: "중소기업청 벤처기업 획득\n기술신용보증기금 우량기술기업인증" },
        { month: "07", content: "중소기업청 INNOBIZ 인증" },
    ...
    },
    {
      year: "2000",
      items: [
        { month: "03", content: "주식회사 지테크인터내셔날 법인 전환" },
